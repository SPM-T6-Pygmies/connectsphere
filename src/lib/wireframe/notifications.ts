...
export const NOTIFICATIONS: readonly NotificationRecord[] = [
  // --- Event Operations Manager (SPM-56) -----------------------------------
  {
    ...
    body: "Alice submitted a request for 240 people on 10 December. No coordinator is assigned yet.",
  ...
  // --- Event Organiser (SPM-58, 59, 60, 66, 68) ---------------------------
  {
    ...
    subject: "Nadia asked you a question",
  ...
  },
  {
    ...
    subject: "Nadia is coordinating your event",
  ...
  },
  {
    ...
    body: "Omar approved the request on 6 September. Planning can now proceed — nothing is booked yet.",
  ...
  // --- Venue Staff (SPM-61, 63) -------------------------------------------
  {
    ...
    body: "Nadia requested AM + PM for the Hybrid Leadership Summit, 180 expected.",
    eventName: "Hybrid Leadership Summit",
  ...
  },
  {
    ...
    body: "Omar requested the AM slot for the Compliance Training Workshop, 38 expected.",
    eventName: "Compliance Training Workshop",
